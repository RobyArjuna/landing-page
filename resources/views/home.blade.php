...
<body class="bg-gradient-to-r from-green-100 to-blue-50">
    ...
    <div class="mx-auto px-6 py-12 max-w-7xl">
        <div class="p-10 flex flex-col md:flex-row items-center justify-center md:justify-between text-center md:text-left space-y-6 md:space-y-0 md:space-x-10">
            ...
            <div class="md:w-1/2 relative">
                <img src="{{ asset('images/people.png') }}" alt="Alumni Tracer" class="mx-auto md:mx-0 w-3/4 sm:w-full">
                <p class="absolute right-0 bottom-0 ml-4 mt-8 text-gray-500 text-lg font-semibold">50% Career Growth</p>
            </div>
        </div>
    </div>
    <div class="container mx-auto px-6 py-12">
        <div class="bg-white rounded-3xl shadow-lg p-8 max-w-3xl mx-auto h-full">
            ...
            <div class="flex flex-wrap justify-center gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md text-center w-full sm:w-64 transition transform hover:bg-blue-50 hover:shadow-lg hover:-translate-y-1">
    ...
    <div class="max-w-screen-lg mx-auto px-6 py-12 bg-gradient-to-r from-green-100 to-blue-50 flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0">
        <div class="md:w-2/3 text-center md:text-left">
            <h3 class="text-2xl font-bold text-green-800 mb-8">Career Development Center UMY</h3>
            <p class="text-gray-600 mb-10">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A ipsum vitae facilis, architecto nihil enim alias assumenda laudantium odit totam, dolorum rerum obcaecati porro qui. Explicabo quas soluta perspiciatis iste at ad enim atque sunt, nihil ipsum aspernatur.
            </p>
        </div>
        <div class="w-full md:w-1/3 mb-6 md:mb-0 flex justify-center">
            <img src="{{ asset('images/woman.png') }}" alt="Career Development" class="rounded-full w-3/4 sm:w-2/3 md:w-full">
        </div>
    </div>
